...
'is'||unistr('\000a')||
'begin'||unistr('\000a')||
'  APEX_JAVASCRIPT.ADD_ONLOAD_CODE (q''['||unistr('\000a')||
'  $( "#EXCEL" ).on( "click", function() {'||unistr('\000a')||
'  var colWidthsDelimeteredString = "";'||unistr('\000a')||
'  var colWidthsArray = Array ();'||unistr('\000a')||
'  '||unistr('\000a')||
'  $( ".apexir_WORKSHEET_DATA th" ).each(function( index,elmt ) {    '||unistr('\000a')||
'    colWi'||
'dthsArray[elmt.id] = $(elmt).width();  '||unistr('\000a')||
'  });'||unistr('\000a')||
'  for (var i in colWidthsArray) {'||unistr('\000a')||
'   colWidthsDelimeteredString = colWidthsDelimeteredString + i + ''\,'' + colWidthsArray[i] + "=";  '||unistr('\000a')||
'  }'||unistr('\000a')||
'  javascript:apex.navigation.redirect(''f?p=&APP_ID.:&APP_PAGE_ID.:&APP_SESSION.:GPV_IR_TO_MSEXCEL''+colWidthsDelimeteredString+'':NO:::'');'||unistr('\000a')||
'  });]''                           '||unistr('\000a')||
'  );'||unistr('\000a')||
''||unistr('\000a')||
'  if :REQUEST like ''GPV_IR_TO_MSEXCEL%'''||
' then'||unistr('\000a')||
'    if p_process.attribute_07 = ''E'' then -- Excel XLSX'||unistr('\000a')||
...
'                                p_col_length   => regexp_replace(:REQUEST,''^GPV_IR_TO_MSEXCEL'',''''),'||unistr('\000a')||
'                                p_coeffici'||
'ent  => p_process.attribute_09'||unistr('\000a')||
'                                );'||unistr('\000a')||
'    elsif p_process.attribute_07 = ''X'' then -- XML'||unistr('\000a')||
'      IR_TO_XML.get_report_xml(p_app_id            => :APP_ID,'||unistr('\000a')||
'                               p_page_id           => :APP_PAGE_ID,       '||unistr('\000a')||
'                               p_return_type       => ''X'',                        '||unistr('\000a')||
'                               p_get_page_items    => ''N'','||unistr('\000a')||
'   '||
'                            p_items_list        => null,'||unistr('\000a')||
'                               p_collection_name   => null,'||unistr('\000a')||
'                               p_max_rows          => p_process.attribute_05'||unistr('\000a')||
'                              );'||unistr('\000a')||
'    elsif p_process.attribute_07 = ''T'' then -- Debug txt'||unistr('\000a')||
'      IR_TO_XML.get_report_xml(p_app_id            => :APP_ID,'||unistr('\000a')||
'                               p_page_id           =>'||
' :APP_PAGE_ID,       '||unistr('\000a')||
'                               p_return_type       => ''Q'',                        '||unistr('\000a')||
'                               p_get_page_items    => ''N'','||unistr('\000a')||
'                               p_items_list        => null,'||unistr('\000a')||
'                               p_collection_name   => null,'||unistr('\000a')||
'                               p_max_rows          => p_process.attribute_05'||unistr('\000a')||
...
'   '||
'else'||unistr('\000a')||
'    raise_application_error(-20001,''GPV_IR_TO_MSEXCEL : unknown Return Type'');'||unistr('\000a')||
'   end if;'||unistr('\000a')||
' end if;'||unistr('\000a')||
...
wwv_flow_api.create_plugin_attribute (
 ...
 ,p_default_value => '6'
 ,p_is_translatable => false
 ,p_help_text => 'Coefficient to convert display column width in pixels to column width in Excel.'
  );
null;
